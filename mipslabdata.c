...
/** Buttons **/
const int BTN1 = 0x0002;
const int BTN2 = 0x0020;
const int BTN3 = 0x0040;
const int BTN4 = 0x0080;

/** Switch **/
const int SW1 = 0x0100;
...
char* DISPLAY_PLAYER_WON = "PLAYER WON ";
char* DISPLAY_DEALER_WON = "DEALER WON ";
char* DISPLAY_DRAW_GAME = "ITS A DRAW!";
char* DISPLAY_NEW_GAME = "AGAIN? (BTN2)";
